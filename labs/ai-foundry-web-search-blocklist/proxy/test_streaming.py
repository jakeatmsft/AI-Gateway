...
from proxy.filtering import DomainRedactor, InvalidRequest
from proxy.streaming import EventFilter, SSEFrames, frame_data, redact_event, redact_events, search_evidence, call_redactor
...
async def test_two_event_envelope_obeys_the_total_request_size_limit(monkeypatch):
    import proxy.streaming as module
