...
// 5. APIM VoiceLive Websocket API
...
resource api 'Microsoft.ApiManagement/service/apis@2024-06-01-preview' = {
  ...
  properties: {
    apiType: 'websocket'
    description: 'Inference API for Azure AI VoiceLive'
    displayName: 'VoiceLiveAPI'
    path: '${inferenceAPIPath}/voice-live/realtime'
    serviceUrl: 'wss://${foundryModule.outputs.extendedAIServicesConfig[0].cognitiveServiceName}.services.ai.azure.com/voice-live/realtime'
